    ...
    <DashboardLayout userRole="recruiter">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {jobOpenings.map((job) => {
            const { id, title, department, location, type, status, applicants, in_pipeline, posted } = job;
            return (
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-6 text-sm text-muted-foreground">
                      ...
                      <span>•</span>
                      <span>{in_pipeline} in pipeline</span>
                      <span>•</span>
                      <span>Posted {formatDate(posted)}</span>
                    </div>
                  </div>

                  <div className="flex gap-2">
                    <Button variant="default" asChild>
                      <Link to={`/dashboard/jobs/${id}/applicants`}>
